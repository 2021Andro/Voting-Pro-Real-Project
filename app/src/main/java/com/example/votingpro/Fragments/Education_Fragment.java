...
public class Education_Fragment extends Fragment implements RecFragClickEvent {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_education_, container, false);

        rvList = view.findViewById(R.id.rvEducationList_EF);

        layoutManager = new LinearLayoutManager(view.getContext());

        myRVFragAdapter = new MyRVFragAdapter(Education_Fragment.this);
