...
public class Social_Fragment extends Fragment implements RecFragClickEvent {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvSocial = view.findViewById(R.id.rvSocialList_SF);

        layoutManager = new LinearLayoutManager(getContext());

        myRVFragAdapter = new MyRVFragAdapter(Social_Fragment.this);

        rvSocial.setLayoutManager(layoutManager);

        rvSocial.setAdapter(myRVFragAdapter);
